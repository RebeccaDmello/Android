       ...
       // img.setBounds(0, 0, 100, 100);
        ...
        txtViewWelcomeMsg.setOnTouchListener(new CustomTouchListener(this){
            ...
            public void onSwipeUp() {
                ...
                txtViewWelcomeMsg.setGravity(horzGravity | Gravity.TOP);
                super.onSwipeUp();
            }
            ...
            public void onSwipeDown() {
                ...
                int horzGravity = txtViewWelcomeMsg.getGravity() & Gravity.HORIZONTAL_GRAVITY_MASK;
                txtViewWelcomeMsg.setGravity(horzGravity | Gravity.BOTTOM);
                super.onSwipeDown();
            }
            ...
            public void onSwipeRight() {
               ...
               // txtViewWelcomeMsg.setGravity(Gravity.TOP | Gravity.LEFT);
                int verGravity = txtViewWelcomeMsg.getGravity() & Gravity.VERTICAL_GRAVITY_MASK;
                txtViewWelcomeMsg.setGravity(verGravity | Gravity.RIGHT); //bitwise OR operator combines horz and vertical
                super.onSwipeRight();
            }
        ...
        imgViewSample.setOnTouchListener(new CustomTouchListener(this){
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
               ...
               // return false; //useful to test if set to false, other gestures may not be detected
                //If you return false in onTouch
                //you can instantiate the constraint layout object in the onCreate method
                //and set up a click listener for it...
                //maybe change the background color of the layout itself
                //false means the touch event is not consumed and can be passed
                //to the containing view listeners
            }
        });
